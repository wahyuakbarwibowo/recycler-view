...
class CardViewHeroAdapater(private val listHero: ArrayList<Hero>) : RecyclerView.Adapter<CardViewHeroAdapater.CardViewViewHolder>() {
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): CardViewHeroAdapater.CardViewViewHolder {
        val view: View = LayoutInflater.from(parent.context).inflate(R.layout.item_cardview_hero, parent, false)
        return CardViewViewHolder(view)
    }

    override fun onBindViewHolder(holder: CardViewHeroAdapater.CardViewViewHolder, position: Int) {
